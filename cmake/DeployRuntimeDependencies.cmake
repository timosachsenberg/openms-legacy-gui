...
if((NOT DEFINED EXECUTABLE OR "${EXECUTABLE}" STREQUAL "")
   AND (NOT DEFINED EXECUTABLES OR "${EXECUTABLES}" STREQUAL "")
   AND (NOT DEFINED LIBRARIES OR "${LIBRARIES}" STREQUAL ""))
  message(FATAL_ERROR "At least one of EXECUTABLE, EXECUTABLES, or LIBRARIES must be passed")
endif()
...
if(DEFINED EXECUTABLES AND NOT "${EXECUTABLES}" STREQUAL "")
  foreach(_executable IN LISTS EXECUTABLES)
    if(NOT EXISTS "${_executable}")
      message(FATAL_ERROR "Executable does not exist: ${_executable}")
    endif()
  endforeach()
  list(APPEND _dependency_roots EXECUTABLES ${EXECUTABLES})
endif()
